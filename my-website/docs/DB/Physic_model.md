...
entity "activity_organization" {

- id : INT <<PK>> <<NOT NULL>>

- organization_id_id : INT <<FK>><<NOT NULL>>

- activitiy_id : INT <<FK>>
}

entity "address_volunteer" {
...
"volunteer" ||--o{ "activity_volunteer" : " has"

"organization" ||--o{ "activity_organization" : "has"

"activities" ||--o{ "activity_organization" : ""

"activities" ||--o{ "activity_volunteer" : ""

"volunteer" ||--o{ "address_volunteer" : "has"

"organization" ||--o{ "address_organization" : "has"
